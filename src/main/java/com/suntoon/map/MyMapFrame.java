 ...
 * @ClassName MyMapFrame
 * @Description TODO
 * @Author YueLifeng
 * @Date 2019/5/6 0006上午 10:45
 * @Version 1.0
 */
public class MyMapFrame extends JMapFrame {
    ...
    private Set<JMapFrame.Tool> toolSet;
     ...
     * @param content the map content
     */
    public MyMapFrame(MapContent content) {
        super(content);
        ...
        showStatusBar = false;
        showToolBar = false;
        toolSet = EnumSet.noneOf(JMapFrame.Tool.class);
