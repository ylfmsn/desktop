...
import com.suntoon.map.utils.RangeHashMap;
...
public class ScalebarPlugin extends PluginBase {
    ...
    //标尺的表示范围 double 真实的地理空间跨度，单位米 Pair.Integer表示的比例尺
    ...
    public void beforePaint(Graphics2D g2d) {
        ...
        double pixelPerDistance = distance / location.getWidth();     //每个像素代表距离
