 ...
 * @ClassName AbstractPatternPanel
 * @Description TODO
 * @Author YueLifeng
 * @Date 2019/4/15 0015下午 2:45
 * @Version 1.0
 */
public abstract class AbstractPatternPanel extends JPanel {

    private static final long serialVersionUID = -7753190569739964261L;
    ...
    public static final String MATCH_ACTION_COMMAND = "macth";
...
//-------------------------- config helpers
    ...
    protected void initComponents() {
        ...
        searchField = new JTextField(getSearchFieldWidth()) {
            ...
            private static final long serialVersionUID = -7712131400890280754L;
