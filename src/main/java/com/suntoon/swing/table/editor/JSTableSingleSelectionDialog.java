...
import com.suntoon.swing.table.view.JSTableColumnMapping;
import com.suntoon.swing.table.view.JSTableColumnMappingAbstract;
 ...
 * @ClassName JSTableSingleSelectionDialog
 * @Description 单行数据选择对象
 * @Author YueLifeng
 * @Date 2019/4/25 0025下午 3:04
 * @Version 1.0
 */
...
//				getRootPane().setDefaultButton(btnFind);
    ...
    public void initTable()
    {
        ...
        JSTableBuilder<?> builder = new JSTableDefaultBuilderImpl<>(colMapping.getEntityClass(),columns);
