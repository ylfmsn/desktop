...
import com.suntoon.swing.table.editor.*;
import com.suntoon.swing.table.header.JSTableHeaderCheckboxRenderer;
import com.suntoon.swing.table.renderer.*;
 ...
 * @ClassName JFrameDefaultTableDemo
 * @Description table表格方法
 * @Author YueLifeng
 * @Date 2019/4/22 0022下午 5:21
 * @Version 1.0
 */
public class JFrameDefaultTableDemo extends JFrame {
    ...
    protected void initCompents() {
        ...
        col6.setCellRenderer(new JSTableRadioButtionGroupRenderer<Integer, String>(roles));
        ...
        try {
            ...
            tableModel.setTableModelListener(new JSTableModelDefaultAdapter<TestEntity>() {
                /**
                 * 加载数据的方法
                 */
